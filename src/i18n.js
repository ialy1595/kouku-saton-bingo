      ...
      en: {
        translation: {
          ...
          options: {
            ...
            speech: "Speech recognition (Unavailable for EN)",
          ...
          description: {
            ...
            "If you click the wrong button, you can go back with the [Undo] button, and if you want to reset the board, just click the [Reset] button.",
            q2: "Q. Where should I put the bombs?",
            a2: "The tool has a recommendation function, the bingo tiles with a blue background are the recommended ones.\n" +
            "The function tries to play a bingo every 3rd round, and also tries to keep Kakul in the middle-top location.\n" +
            ...
            q4: "Q. What if I don't want to stand on skulls to drop bombs?",
            a4: "With this tool, it's possible to adjust your preferences for bombs on skulls using the slider. The left side will result in more recommendations to place bombs on skulls (if it helps keep the board clean) and the right side will try to avoid placing bombs on skulls.",
            ...
            a6: "I designed the tool to be easy to view and use on mobile. Probably.",
